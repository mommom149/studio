  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
        className={cn(
          "group hidden md:flex flex-col h-full bg-sidebar text-sidebar-foreground transition-all duration-300 ease-in-out",
          "data-[state=expanded]:w-[--sidebar-width]",
          collapsible === "offcanvas" && "data-[state=collapsed]:w-0 data-[state=collapsed]:p-0 data-[state=collapsed]:opacity-0",
